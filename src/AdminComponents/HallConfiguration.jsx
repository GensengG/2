...
export const HallConfiguration = ( {hallsStart} ) => {    
    ...
    let [hallArr, setHallArr] = useState([]);
    let [hallElements, setHallElements] = useState([]);
    // let hallConfig = [];
...
//                 const activeHallName = document.getElementsByClassName("hall__config__name__active")[0]?.textContent;
//                 if (activeHallName) {
//                     startHall(activeHallName);
//                 }
//             });
//     }, []);
...
//         // newgrid.places = Number(document.getElementById("place").value);
//         // newgrid.config = newConfig;
//         newgrid.row= rowCount;
//         newgrid.places= placeCount;
//         newgrid.config= newConfig;
